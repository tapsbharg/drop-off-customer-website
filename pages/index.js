      ...
      <div className="pageInsieWRp">
        <div className="slider d-flex align-items-center justify-content-center">
          <div className="container">
              ...
              {dashdata.map((data, index) => (
                <li key={index} data-aos="fade-up" data-aos-duration="1000">
                  <div
                    ...
                    className={cateData == data._id ? "active" : ""}
                  >
                    <a>
                      <img
                        src={`/assets/images/catNumber${data.catNumber}.svg`}
                        alt=""
                      />
                      <span>{data.name}</span>
                    </a>
            ...
            <div
              className="search text-center mt-3 pt-5"
              data-aos="zoom-in"
                      ...
                      <div className="d-flex flex-wrap align-items-center justify-content-between tabboxWrap my-5">
                        {data.vendors &&
                          data.vendors.map((vendorStore, key) => (
                            <Link
                              href={`store-view?id=${vendorStore._id}`}
                              key={key}
                            >
                              <div className="store_box bg-light02 d-flex flex-wrap Pointer">
                                <div
                                  className={`store_box_img ${
                                    vendorStore.image ? "" : "store_box_border"
                                  }`}
                                >
                                  {vendorStore.image && (
                                ...
                                <div className="store_content">
                                  ...
                                  <div className="starsRating">
                                    ...
                                    />
                                    <sup>
                                      {Math.floor(vendorStore.rating / 0.5) *
                                        0.5}
                                    </sup>
                                  </div>
          ...
          <div className="container">
            ...
            <div className="works_inner d-flex align-items-center justify-content-between mt-5">
              ...
              >
                ...
                <p>
                  Choose your desired products from nearby located different
                  stores
                </p>
              </div>
              <div
              ...
              >
                ...
                <h5>Easy Checkout</h5>
                <p>
                  Order from the best local liquor stores, grocery stores,
                  dispensaries and pharmacies with easy, on-demand delivery.
                </p>
              </div>
              <div
                className="works"
              ...
              >
                ...
                <p>
                  Get quick or scheduled delivery for your desired products from
                  driver.
                </p>
              </div>
            </div>
            ...
            <div className="row">
              ...
              <div className="col-sm-7">
                ...
                <p>
                  ...
                  aliquyam erat, sed diam voluptua. At vero eos et accusam et
                  justo duo dolores et ea rebum. Stet clita kasd gubergren, no
                  sea takimata sanctus est Lorem ipsum dolor sit ametLorem ipsum
