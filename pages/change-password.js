...
export default function ChangePasswordPage(props) {
    const initialValues = {
      ...
      const validationSchema = Yup.object({
        ...
        .test("match", "Your new password and confirm password does not match", (value) => {
                                ...
                                <div className="comman_from">
                                    ...
                                    <form className="change_pass" onSubmit={formik.handleSubmit}>
                                        <div className="mb-3">
                                            ...
                                            <input type="password" {...formik.getFieldProps("password")} className="form-control" placeholder="Enter Current Password"/>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="password" {...formik.getFieldProps("confirmPassword")} className="form-control" placeholder="Enter New Password"/>
